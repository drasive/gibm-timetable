module.exports = {
  "Acceptance test - Selection of profession influences selectable classes (Spec. #5)" : function (browser) {
    browser
      ...
      .waitForElementVisible("#class option[value = '2467010']", 5000) // Class "IAP 14-18 B" should be selectable (classes are loaded using AJAX)
      ...
      .waitForElementVisible("#class option[value = '2467116']", 5000) // Classes are loaded using AJAX
      
      .click("#profession option[value = '-']") // Select profession "-" (nothing)
      .waitForElementNotVisible("#class", 500) // No class should be selectable
      
      .click("#profession option[value = '3']") // Select profession "Berufsmatura"
      .waitForElementVisible("#class option[value = '2466850']", 5000) // Class "BMI 14-18 A" should be selectable (classes are loaded using AJAX)
