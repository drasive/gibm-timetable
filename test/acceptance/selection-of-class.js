module.exports = {
  "Acceptance test - Selection of class influences displayed lessons (Spec. #6)" : function (browser) {
    browser
      ...
      .waitForElementVisible("#lessons-result #l2586739", 5000) // Subject "M431" should be displayed (lessons are loaded using AJAX)
      ...
      .waitForElementVisible("#lessons-result #l2552721", 5000) // Subject "Allgemeinbildung" should be displayed (lessons are loaded using AJAX)
      ...
      .waitForElementVisible("#lessons-result #l2469956", 5000) // Subject "Deutsch" should be displayed (lessons are loaded using AJAX)
      ...
      .waitForElementVisible("#lessons-result #l2469837", 5000) // Subject "Mathematik" should be displayed (lessons are loaded using AJAX)
